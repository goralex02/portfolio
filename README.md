...
|[07. Кластеризация музыки](https://github.com/goralex02/Data_Processing_and_Machine_Learning/blob/main/ML_07_Audio_Clustering.ipynb)|кластеризуем и визуализируем музыку по жанрам на основе данных о прослушиваниях из онлайн-сервиса.|**Машинное обучение**, **Кластеризация**, **Визуализация**|*Python*, *Pandas*, *Matplotlib*, *Scikit-learn*|
